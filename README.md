...
If I have devices that require different voltages, I'll also need to look into [DC-DC converters](https://github.com/dlynch7/P-Bot/blob/master/Electronics/Notes:%20DC-DC%20converters.md). I may also have to consider [filter/decoupling capacitors](http://www.vagrearg.org/content/decoupling).
